...
export const Header = async () => {
    ...
    return (
        <header className="px-3 py-2 md:py-4 bg-bgdark fixed top-0 w-full z-30 shadow-sm flex flex-row md:flex-row gap-4 items-center justify-between">
            <Link className="flex items-center gap-1" href={'/'}><Image className="w-10" src={logo} alt="logo" /><h1 className="font-mono text-lg font-bold text-bgdark md:text-neutral-100 ">BuzzBoard</h1></Link>
            {/* {user ? (
                <div className="flex">
